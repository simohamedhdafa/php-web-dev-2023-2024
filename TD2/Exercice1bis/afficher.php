...
<body>
    <h1>Consultation de:</h1>
    <div class="container">
        <ul>
            <li><a href="etat_civil.php?nom=<?php echo $form_data['nom']; ?>&prenom=<?php echo $form_data['prenom']; ?>">votre état civil</a></li>
            <li><a href="adresse.php?adresse=<?php echo $form_data['adresse']; ?>&ville=<?php echo $form_data['ville']; ?>&codepostal=<?php echo $form_data['codepostal']; ?>">votre adresse</a></li>
        </ul>
